function varargout = autosnap_Gui_beta3_prime_part_push_rename_beta_v6(varargin)
% AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6 MATLAB code for autosnap_Gui_beta3_prime_part_push_rename_beta_v6.fig
%      AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6, by itself, creates a new AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6 or raises the existing
%      singleton*.
%
%      H = AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6 returns the handle to a new AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6 or the handle to
%      the existing singleton*.
%
%      AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6.M with the given input arguments.
%
%      AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6('Property','Value',...) creates a new AUTOSNAP_GUI_BETA3_PRIME_PART_PUSH_RENAME_BETA_V6 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before autosnap_Gui_beta3_prime_part_push_rename_beta_v6_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to autosnap_Gui_beta3_prime_part_push_rename_beta_v6_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help autosnap_Gui_beta3_prime_part_push_rename_beta_v6

% Last Modified by GUIDE v2.5 11-Nov-2020 18:12:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @autosnap_Gui_beta3_prime_part_push_rename_beta_v6_OpeningFcn, ...
                   'gui_OutputFcn',  @autosnap_Gui_beta3_prime_part_push_rename_beta_v6_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before autosnap_Gui_beta3_prime_part_push_rename_beta_v6 is made visible.
function autosnap_Gui_beta3_prime_part_push_rename_beta_v6_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to autosnap_Gui_beta3_prime_part_push_rename_beta_v6 (see VARARGIN)

% Choose default command line output for autosnap_Gui_beta3_prime_part_push_rename_beta_v6
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes autosnap_Gui_beta3_prime_part_push_rename_beta_v6 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = autosnap_Gui_beta3_prime_part_push_rename_beta_v6_OutputFcn(hObject, eventdata, handles) 
...
handles.start_pad1=get(handles.pad_start_ind1,'String');
handles.start_pad1=str2double(handles.start_pad1);

handles.no_rename=get(handles.button_no_renaming, 'Value');
handles.only_plot=get(handles.button_only_plot, 'Value');
...
if handles.pads==0
    ...
    %autosnap_beta_error_send_5_prime_v4(handles.pads,handles.number_of_pos, handles.posname, handles.cstring, get(handles.output_folder, 'String'), handels.posname_title, get(handles.auto_print,'Value'),handles.start_pad1);
    %autosnap_beta_error_send_5_prime_v5(handles.pads,handles.number_of_pos, handles.posname, handles.cstring, get(handles.output_folder, 'String'), handels.posname_title, get(handles.auto_print,'Value'),handles.start_pad1);
    autosnap_beta_error_send_5_prime_only_rename_plot_beta_v1(handles.pads,handles.number_of_pos, handles.posname, handles.cstring, get(handles.output_folder, 'String'), handels.posname_title, get(handles.auto_print,'Value'),handles.start_pad1,handles);
end
...
% --- Executes during object creation, after setting all properties.
function print_now_CreateFcn(hObject, eventdata, handles)
% hObject    handle to print_now (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function pad_start_ind1_Callback(hObject, eventdata, handles)
% hObject    handle to pad_start_ind1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of pad_start_ind1 as text
%        str2double(get(hObject,'String')) returns contents of pad_start_ind1 as a double


% --- Executes during object creation, after setting all properties.
function pad_start_ind1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pad_start_ind1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes on button press in button_no_renaming.
function button_no_renaming_Callback(hObject, eventdata, handles)
% hObject    handle to button_no_renaming (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of button_no_renaming


% --- Executes on button press in button_only_plot.
function button_only_plot_Callback(hObject, eventdata, handles)
% hObject    handle to button_only_plot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of button_only_plot
